![header](https://capsule-render.vercel.app/api?type=wave&color=gradient&height=300&section=footer&text=Summer%20research%20scheme%20with%20WDSS%20render&fontSize=40) <br />
...
Applications that can be explored lie in exploring geographical determinants relevant for evaluating health intervention programmes or disaster management policies (there exist spatial inequalities within neighbourhoods such as poor road conditions that have an impact on child mortality or higher education outcomes for example). Another area of application could lie in exploring spatio-temporal dependencies to model climate data. Models that can be used are spatial autoregressive models, GLM, Bayesian Hierarchical models for example.
<br />
...
Application areas can lie in the use of medical images or satellite images. <br />
